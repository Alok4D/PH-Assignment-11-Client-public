...
import footerLogo from '../assets/Nav-Logo/logo.svg';
    ...
    <div className="border rounded-sm">
      <footer className="pt-14 w-full  bg-base-200 text-base-content ">
        <div className="footer w-[85%] lg:h-[280px] lg:w-[80%] mx-auto ">
          ...
          <div className="flex ">
            <nav className="grid mr-24 grid-cols-1 space-y-2">
          ...
          <form>
            ...
            <fieldset className="form-control w-80">
              ...
              <div className="join">
                ...
                />
                <button className="btn bg-[#F60] join-item">Subscribe</button>
              </div>
            </fieldset>
          </form>
        </div>
      ...
      <footer className="dark:bg-gray-100 dark:text-gray-900">
        <div className="container flex flex-col p-4 mx-auto  lg:flex-row dark:divide-gray-600">
          <ul className="self-center text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
            <h2 className="cursor-pointer">
              Copyright © 2024 Vactor Store. All Rights Reserved.
            </h2>
          </ul>
